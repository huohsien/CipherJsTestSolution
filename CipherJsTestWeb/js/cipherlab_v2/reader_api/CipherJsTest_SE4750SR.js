class CipherJsTest_SE4750SR extends CipherJsTestActionBase
{
    initCipherJsData()
    {
        this.setReaderTypeName("CL_2D_SE4750SR");
       ...
       //UserPreferences
       this.addUserPreferencesData("addonSecurityLevel", true, 10,	[2,30], [0,1,31]);
    //    this.addUserPreferencesData("displayMode", true, ,	[], []);
    //    this.addUserPreferencesData("laserOnTime", true, ,	[], []);
    //    this.addUserPreferencesData("negativeBarcodes", true, ,	[], []);
    //    this.addUserPreferencesData("pickListMode", true, ,	[], []);
    //    this.addUserPreferencesData("redundancyLevel", true, ,	[], []);
    //    this.addUserPreferencesData("scanAngle", true, ,	[], []);
    //    this.addUserPreferencesData("securityLevel", true, ,	[], []);
    //    this.addUserPreferencesData("timeoutBetweenSameSymbology", true, ,	[], []);
    //    this.addUserPreferencesData("transmitCodeIdChar", true, ,	[], []);
    //    this.addUserPreferencesData("triggerMode", true, ,	[], []);
    //    this.addUserPreferencesData("decodingillumination", true, ,	[], []);
    //    this.addUserPreferencesData("decodingAimingPattern", true, ,	[], []);
    //    this.addUserPreferencesData("interCharGapSize", true, ,	[], []);
    //    this.addUserPreferencesData("timeoutPresentationMode", true, ,	[], []);
    //    this.addUserPreferencesData("decodingIlluminationPowerLevel", true, 10,	[0, 1, 10], [-1, 11]);
    //    this.addUserPreferencesData("aimerMode",  false, undefined,	-1, [0,1]);
    //    this.addUserPreferencesData("centerDecoding", false, undefined,	-1, [0,1]);
    //    this.addUserPreferencesData("centerDecodingTolerance", true, -1,	-1, [0, 100]);
    //    this.addUserPreferencesData("triggerPresentaionMode", true, false, null, null);
...
//var jsTestSE4750SR = CipherJsTest_SE4750SR || {};
